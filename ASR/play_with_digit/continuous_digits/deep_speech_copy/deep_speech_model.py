...
def _rnn_layer(inputs, rnn_cell, rnn_hidden_size, layer_id, is_batch_norm,
    ...
    if is_bidirectional:
        outputs, _ = tf.nn.bidirectional_dynamic_rnn(cell_fw=fw_cell, cell_bw=bw_cell,
...
class DeepSpeech2(object):
    ...
    def __call__(self, inputs, training):
        ...
        # [batch_size, max_timesteps_of_curr_batch, features, channels]
        ...
        for layer_counter in xrange(self.num_rnn_layers):
            ...
            inputs = _rnn_layer(inputs, rnn_cell, self.rnn_hidden_size, layer_counter + 1,
